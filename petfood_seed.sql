-- ============================================================
-- Pet Food Bag — PRODUCTION SCHEMA + FULL SEED
...
VALUES
(
  'Farmers Choice Team Pet/Dog Food 2Kg', 'Farmers Choice', 2, 'dog', 'wet',
...
(
  'Farmers Choice Beef Dog Food 2Kg', 'Farmers Choice', 2, 'dog', 'wet',
...
(
  'Bravo Dog Food Adult Chicken 2Kg', 'Bravo', 2, 'dog', 'dry',
...
(
  'Top Dog Krunshi Economy Dog Food 5kg', 'Top Dog', 5, 'dog', 'dry',
...
(
  'Top Dog Rice And Chicken Puppy Food 5Kg', 'Top Dog', 5, 'dog', 'dry',
...
(
  'Top Dog Rice And Fish Puppy Food 5Kg', 'Top Dog', 5, 'dog', 'dry',
...
(
  'Bravo Beef Flavour Active Dog Food 15Kg', 'Bravo', 15, 'dog', 'dry',
  NULL,
...
(
  'Bravo Chicken Flavour Adult Dog Food 15Kg', 'Bravo', 15, 'dog', 'dry',
  NULL,
...
(
  'Purr-fect Chicken & Rice Cat Food 2kg', 'Purr-fect', 2, 'cat', 'dry',
...
(
  'Top Dog Puppy Rice And Chicken Dog Food 2kg', 'Top Dog', 2, 'dog', 'dry',
...
(
  'Gilani Gourmet Pet Biltong 250g', 'Gilani', 0.25, 'dog', 'treat',
...
(
  'T.L.C. Dog Rice 5Kg', 'T.L.C.', 5, 'dog', 'dry',
...
(
  'Scooby Premium Dog Rice 10Kg', 'Scooby', 10, 'dog', 'dry',
  NULL,
...
(
  'T.L.C. Dog Rice 3Kg', 'T.L.C.', 3, 'dog', 'dry',
  NULL,
...
(
  'Scooby Dog Rice 5Kg', 'Scooby', 5, 'dog', 'dry',
  NULL,
...
(
  'T.L.C. Dog Rice 10Kg', 'T.L.C.', 10, 'dog', 'dry',
  NULL,
...
(
  'T.L.C. Dog Meal 5Kg', 'T.L.C.', 5, 'dog', 'dry',
  NULL,
...
(
  'Purrfect Kitten Chicken & Rice 1kg', 'Purrfect', 1, 'cat', 'dry',
  NULL,
...
(
  'Bark Bite Mini Dog Chews Beef 100g', 'Bark Bite', 0.1, 'dog', 'treat',
  NULL,
...
(
  'Bark Bite Mini Dog Chew Chicken 100g', 'Bark Bite', 0.1, 'dog', 'treat',
  NULL,
...
(
  'T.L.C. Dog Chews 250g', 'T.L.C.', 0.25, 'dog', 'treat',
...
(
  'Bravo Active Beef Flavour 2Kg', 'Bravo', 2, 'dog', 'dry',
...
(
  'Top Dog Rice 10Kg', 'Top Dog', 10, 'dog', 'dry',
...
(
  'Top Dog Uncooked Dog Rice 5Kg', 'Top Dog', 5, 'dog', 'dry',
...
(
  'Robeliz Omena Dog Food 10kg', 'Robeliz', 10, 'dog', 'dry',
  '/images/products/product_27.jpg',
  'High-Protein Nutrition from Local Kenyan Fish. Formulated using omena (silver cyprinid) – a nutrient-dense small fish abundant in Lake Victoria and Kenyan waters. This recipe provides high-quality protein for strong muscles, healthy skin, and a shiny coat. Perfect for multi-dog households and working dogs.',
  22.0, 10.0, 4.0, 10.0,
...
(
  'Omena Perfect Mix Dog Meal 5kg', 'Omena Perfect Mix', 5, 'dog', 'dry',
