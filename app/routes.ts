...
const routes = [
  ...
  route("about-petstore-kenya", "routes/about-us.tsx", { id: "about-petstore-kenya-alias" }),
  ...
  route("retail-locations", "routes/retail-locations.tsx"),
  route("retail-locations-nairobi-nanyuki-naivasha-nakuru-mombasa", "routes/retail-locations.tsx", { id: "retail-locations-long-alias" }),
