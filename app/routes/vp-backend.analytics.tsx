  ...
  return (
    <div className="analytics-page">
      ...
      <div className="info-alert">
        <span>Analytics now supports scheduled updates, providing improved performance. Enable it in <Link to="/vp-backend/analytics?view=settings">Settings</Link>.</span>
