      ...
      {actionParam === "upload" ? (
        <div className="upload-media-page">
          ...
          <div className="upload-workspace">
            <div className="upload-header-row">
              <h2>Upload Media</h2>
              <Link to="/store_backend/media" className="layout-toggle-btn" style={{ textDecoration: "none" }}>
                📁 View Library
              </Link>
            </div>
        ...
        <>
          ...
          <div className="media-header-banner">
            ...
            <Link to="/store_backend/media?action=upload" className="btn-add-media" style={{ textDecoration: "none" }}>
