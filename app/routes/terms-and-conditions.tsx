...
export default function TermsAndConditions() {
  const sections = [
    ...
    {
      title: "Copyright",
      content: "All copyright, trademarks and all other intellectual property rights in the Website and its content (including without limitation the Website design, text, graphics and all software and source codes connected with the Website) are owned by or licensed to Loki Ventures Ltd. / PetStore Kenya or otherwise used by Loki Ventures Ltd. / PetStore Kenya as permitted by law.\n\nIn accessing the Website you agree that you will access the content solely for your personal, non-commercial use. None of the content may be downloaded, copied, reproduced, transmitted, stored, sold or distributed without the prior written consent of the copyright holder. This excludes the downloading, copying and/or printing of pages of the Website for personal, non-commercial home use only."
    },
    {
    ...
    {
      title: "Return Policy",
      content: "We offer 100% money back (refund) guarantee. Customer must return products in their original packaging to our main headquarters."
    },
    {
    ...
    {
      title: "Governing Law",
      content: "These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of P.O. Box 48960-00100, Nairobi, Kenya."
    },
    {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Terms and Conditions of PetStore Kenya (petstore.co.ke) Website
          </h2>
