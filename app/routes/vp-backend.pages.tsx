...
export async function action({ request }: { request: Request }) {
  ...
  if (intent === "quick_edit") {
    ...
    const link = `https://visionplus.co.ke/${parentPath}${slug}/`;
    ...
    pageDetails.seo.title = pageDetails.seo.title || `${title} - Vision Plus`;
  ...
  if (intent === "save_page_details") {
    ...
    pageDetails.seo = {
      title: seoTitle || `${title} - Vision Plus`,
    ...
    return redirect("/vp-backend/pages");
  }
  ...
  if (intent === "duplicate_page") {
    ...
    if (summary) {
      try {
        ...
        const link = `https://visionplus.co.ke/${parentPath}${newSlug}/`;
        ...
        const clonedDetails = {
          ...
          seo: {
            ...originalDetails.seo,
            title: originalDetails.seo?.title ? `${originalDetails.seo.title} (Copy)` : `${newTitle} - Vision Plus`,
            canonical: link
          }
        };
                      ...
                      <tr key={page.id}>
                        ...
                        {showTitleCol && (
                          <td>
                            ...
                            <div className="row-actions">
                              ...
                              <Link
                                to={`/vp-backend/pages?view=edit&id=${page.id}`}
                        ...
                        {showLinkCol && (
                          <td>
                            ...
                            >
                              {page.link.replace("https://visionplus.co.ke", "") || "/"}
                            </a>
                          </td>
                        )}
                        {showAuthorCol && (
        ...
        <Form method="post" replace>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "28px" }}>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <Link to="/vp-backend/pages" className="btn-action-secondary" style={{ textDecoration: "none" }}>
                Cancel
              </Link>
              ...
              <div className="editor-main-card">
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  <div className="form-group-admin">
                    ...
                    <input
                      ...
                      placeholder={`${titleVal || "Page"} - Vision Plus`}
                      className="admin-input"
                    />
                  </div>
                  <div className="form-group-admin">
                    ...
                    <input
                      ...
                      placeholder={titleVal ? `https://visionplus.co.ke/${slugVal}/` : "Auto-computed canonical url"}
                      className="admin-input"
                    />
                  </div>
                </div>
                ...
                <div className="seo-preview-box">
                  <div className="seo-preview-title">
                    {seoTitleVal || `${titleVal || "New Page"} - Vision Plus`}
                  </div>
                  <div className="seo-preview-link">
                    {canonicalVal || `https://visionplus.co.ke/${slugVal || "new-page"}/`}
                  </div>
