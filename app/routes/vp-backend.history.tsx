  ...
  return (
    <div className="history-page">
      ...
      <div className="history-tabs">
        <a href="/vp-backend/history?view=log" className={`tab-btn ${currentView === "log" ? "active" : ""}`}>
          📋 Event Log
        </a>
        <a href="/vp-backend/history?view=insights" className={`tab-btn ${currentView === "insights" ? "active" : ""}`}>
          📊 History Insights
        </a>
        <a href="/vp-backend/history?view=export" className={`tab-btn ${currentView === "export" ? "active" : ""}`}>
          💾 Export & Tools
        </a>
        <a href="/vp-backend/history?view=settings" className={`tab-btn ${currentView === "settings" ? "active" : ""}`}>
          ⚙️ Settings
        </a>
      </div>
