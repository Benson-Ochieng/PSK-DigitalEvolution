...
export async function loader() {
  ...
  if (topSellers.length === 0) {
    topSellers = [
      {
        name: "Vision Plus Cool Pods-Black",
        count: 14,
        thumbnail: "/assets/images/products/Cool-Pods.jpg",
        price: 525,
      },
      {
        name: "Vision Plus Wireless Power Bank 20000mAh",
        count: 9,
        thumbnail: "/assets/images/products/VPPB20W.png",
        price: 3495,
      },
      {
        name: "55\" 4K Frameless QLED Vidaa TV",
        count: 5,
        thumbnail: "/assets/images/products/VP8855-50QV-NEW-Side.jpg",
        price: 38995,
      },
    ];
  }
      ...
      <div className="widgets-grid">
        ...
        <div className="admin-card">
          <div className="admin-card-header">
            ...
            <Link to="/vp-backend/orders" style={{ fontSize: "12px", color: "#00ccff", textDecoration: "none" }}>View All</Link>
          </div>
