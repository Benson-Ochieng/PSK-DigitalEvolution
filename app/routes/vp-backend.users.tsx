...
export async function action({ request }: { request: Request }) {
  ...
  if (intent === "create_user") {
    ...
    return redirect("/vp-backend/users?success=true");
  }
                    ...
                    <tr key={user.id}>
                      ...
                      <td>
                        <div className="action-flex-row">
                          <Link
                            to={`/vp-backend/users?view=edit&id=${user.id}`}
      ...
      {currentView === "new" && (
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
            ...
            <Link to="/vp-backend/users" className="btn-action-secondary" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "13px" }}>
              ◀ Back to Directory
            </Link>
          </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div className="form-group-admin">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="sam@visionplus.co.ke"
                    required
                  />
                </div>
                <div className="form-group-admin">
