...
export async function action({ request }: { request: Request }) {
  ...
  if (intent === "bulk_trash") {
    ...
    return redirect("/vp-backend/products");
  }
  ...
  if (intent === "save_product_details") {
    ...
    return redirect(`/vp-backend/products?view=edit&id=${productId}&updated=true`);
  }
      ...
      {currentView === "edit" && editingProductDetails && (
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
            ...
            <Link to="/vp-backend/products" className="btn-action-secondary" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "13px" }}>
              ◀ Back to Catalog
            </Link>
          </div>
          ...
          <div className="directory-form-card" style={{ width: "100%" }}>
            <Form method="post" replace>
              ...
              <div className="form-group-admin">
                ...
                <input type="text" name="name" required placeholder="e.g. Vision Plus 55' Smart UHD TV" />
              </div>
