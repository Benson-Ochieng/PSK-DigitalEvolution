    ...
    <>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              <h4>Need Help ?</h4>
              <ul>
                <li><Link to="/shop">See All Our Stores</Link></li>
                <li><Link to="/shop">Pet Avenue</Link></li>
              </ul>
            </div>
            ...
            <div className="footer-col">
              ...
              <div className="footer-socials">
                <a href="https://facebook.com" className="footer-social-link" target="_blank" rel="noreferrer" title="Facebook">
                ...
                <a href="https://instagram.com" className="footer-social-link" target="_blank" rel="noreferrer" title="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="footer-bottom-bar">
          <p>© 2026 PetStore Kenya (Petstore.co.ke) - All Rights Reserved.</p>
        </div>
      </footer>
